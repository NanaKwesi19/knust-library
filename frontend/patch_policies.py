...
# 1. Create LibraryPolicies.tsx
policies_path = "C:/Users/hp/knust-library/frontend/src/components/layout/modules/LibraryPolicies.tsx"
policies_content = """import React from 'react';
...
# 2. Patch App.tsx
app_path = "C:/Users/hp/knust-library/frontend/src/App.tsx"
with open(app_path, "r", encoding="utf-8") as f:
    app_content = f.read()

if "const LibraryPolicies =" not in app_content:
...
if '<Route path="policies" element={<LibraryPolicies />} />' not in app_content:
    app_content = app_content.replace(
...
# 3. Patch PortalLayout.tsx
layout_path = "C:/Users/hp/knust-library/frontend/src/components/layout/PortalLayout.tsx"
with open(layout_path, "r", encoding="utf-8") as f:
    layout_content = f.read()

if "FileText" not in layout_content:
    layout_content = layout_content.replace(
        "Sparkles, UserCircle, Search,",
        "Sparkles, UserCircle, Search, FileText,"
    )

if "{ id: 'policies', name: 'Rules & Policies'" not in layout_content:
    layout_content = layout_content.replace(
...
print("Created LibraryPolicies page and linked it.")
