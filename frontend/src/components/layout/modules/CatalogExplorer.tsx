                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    {book.availableCopies > 0 ? (
                      <span className="inline-flex items-center gap-1 text-[9px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 px-1.5 py-0.5 rounded shrink-0">
                        <CheckCircle className="w-2 h-2" /> In Stock
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1 text-[9px] font-bold bg-rose-50 text-rose-700 border border-rose-200 px-1.5 py-0.5 rounded shrink-0">
                        <XCircle className="w-2 h-2" /> Out
                      </span>
                    )}
                  </div>
