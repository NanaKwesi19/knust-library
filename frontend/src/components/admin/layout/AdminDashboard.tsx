      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center space-y-4">
          ...
          <button
            ...
            className="text-sm font-bold text-[#7A1C2C] hover:underline"
          >
            Go Back
          </button>
        </div>
              ...
              <AnimatePresence mode="wait">
                <Routes>
                  ...
                  <Route
                    path="/borrowing"
                    element={
                      <motion.div key="borrowing" variants={pageVariants} initial="initial" animate="animate" exit="exit">
                        <ProtectedRoute allowedRoles={['ADMIN', 'LIBRARIAN', 'STAFF']}>
                          <BorrowingManagement />
                        </ProtectedRoute>
                      </motion.div>
                  ...
                  <Route
                    path="/fines"
                    element={
                      <motion.div key="fines" variants={pageVariants} initial="initial" animate="animate" exit="exit">
                        <ProtectedRoute allowedRoles={['ADMIN', 'LIBRARIAN']}>
                          <FineManagement />
                        </ProtectedRoute>
                      </motion.div>
                    ...
                    element={
                      ...
                      >
                        <div className="text-center space-y-4">
                          ...
                          <h2 className="text-lg font-black text-slate-900">Page Not Found</h2>
